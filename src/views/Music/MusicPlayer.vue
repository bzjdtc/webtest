...
const playlist = ref([
  {
    ...
    src: 'https://music.163.com/song/media/outer/url?id=692641',
    duration: 319,
    tags: ['J-Pop'],
  ...
  },
  {
    ...
    cover: 'https://p2.music.126.net/16zoRqTa4ENff0ktXu90bg==/109951166239755253.jpg',
    src: 'https://music.163.com/song/media/outer/url?id=410446170',
    duration: 212,
    tags: ['Pure-Music'],
  ...
  },
  {
    ...
    cover: 'https://p1.music.126.net/OGUQ9aZmAW-YFkGc1-uLhw==/109951171354110872.jpg',
    src: 'https://music.163.com/song/media/outer/url?id=494642787',
    duration: 292,
    tags: ['J-Pop'],
  ...
  },    
  {
    ...
    cover: 'https://p1.music.126.net/CmgKk9RF8DabNa9qysR-gQ==/109951170965331107.jpg',
    src: 'https://music.163.com/song/media/outer/url?id=28466084',
    duration: 284,
    tags: ['J-Pop'],
  ...
  },
  {
    ...
    artist: '南條愛乃',
    album: '穢翼のユースティア',
    cover: 'https://p1.music.126.net/re_L6v_1cln2EtcMB_JZUw==/4436529418085628.jpg',
    src: 'https://music.163.com/song/media/outer/url?id=630896',
    duration: 299,
    tags: ['J-Pop'],
